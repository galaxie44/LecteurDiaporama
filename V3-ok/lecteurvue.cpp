    ...
    , ui(new Ui::lecteurVue)
{
    ...
    connect(ui->actionQuitter_2, &QAction::triggered, this, &lecteurVue::toutFermer);
...
void lecteurVue::chargerDiaporama()
{
    ...
    Image* imageACharger;
    imageACharger = new Image(3, "animal", "Dalmatien", "F:\\s2\\s2.01\\img\\cartesDisney\\Disney_1.gif");
    _diaporama.push_back(imageACharger);
    imageACharger = new Image(2, "personne", "Alice", "F:\\s2\\s2.01\\img\\cartesDisney\\Disney_2.gif");
    _diaporama.push_back(imageACharger);
    imageACharger = new Image(4, "animal", "Bambi", "F:\\s2\\s2.01\\img\\cartesDisney\\Disney_3.gif");
    _diaporama.push_back(imageACharger);
    imageACharger = new Image(1, "personne", "Cendrillon", "F:\\s2\\s2.01\\img\\cartesDisney\\Disney_4.gif");
    _diaporama.push_back(imageACharger);
...
void lecteurVue::afficher()
{
    ...
    else
    {
        if (_numDiaporamaCourant > 0)
        {
            ...
            //Permet de définir le mode qui est utilisé actuelement
            string lemode;
            if (etat==manuel)
            {
                lemode="Manuel";
...
void lecteurVue::defile() // Fenetre de changement de vitesse
{
